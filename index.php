...
<html>
<head>
<title>Seni Kebudayaan Dunia Sarjana (SKEDSA)</title>
<meta charset="UTF-8">
...
<nav class="w3-sidebar w3-collapse w3-black w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  <div class="w3-container">
    ...
    <img src="photo/logo.png" style="width:65%;" class="w3-circle" align="center"><br><br>
    <h4><b>SKEDSA</b></h4>
  ...
  <div class="w3-bar-block">
	...
	<a href="admin/index.php" onclick="w3_close()" class="w3-bar-item w3-button w3-padding w3-text-yellow" target="_blank"><i class="fa fa-user fa-fw w3-margin-right"></i>ADMINISTRATOR</a> 
  </div>
...
<!-- Header -->
 ...
 <div class="w3-container w3-padding-large" style="margin-bottom:32px">
    <h4><b>SKEDSA</b></h4>
    <h4><b>1 CUTE 1 SKEDSA 1 FAMILY</b></h4>
