...
if (isset($_POST["submit"])) {
  ...
  $sql = "UPDATE `contact` SET `contact_name`='$contact_name',`contact_studid`='$contact_studid',`contact_desc`='$contact_desc',`contact_email`='$contact_email', 'contact_phone'='$contact_phone' WHERE contact_id = $contact_id";
...
<head>
  ...
  <title>SKEDSA Contacts</title>
</head>

<body>
  <nav class="navbar navbar-light justify-content-center fs-3 mb-5" style="background-color: #CAA95F;">
    Seni Kebudayaan Dunia Sarjana Contacts
  </nav>
